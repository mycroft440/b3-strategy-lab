# top1_risk_adjusted_lb126_skip21_trend200_vol21_equal_monthly_abs_cap1_raw

## Como funciona

- Selecao: `risk_adjusted`; conserva no maximo 1 ativo(s).
- Janela principal: 126 candles; defasagem: 21.
...
```json
{
  "name": "top1_risk_adjusted_lb126_skip21_trend200_vol21_equal_monthly_abs_cap1_raw",
  "lookback": 126,
  "skip": 21,
  "top_n": 1,
  "trend_window": 200,
