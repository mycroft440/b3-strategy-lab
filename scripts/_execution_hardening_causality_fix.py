...
# The legacy validation runner has a fixed staging list. Stage these files here so
# the exact source that passes the suite is persisted on the review branch.
subprocess.run(
    [
        "git",
        "add",
...
print("Halloween causality fix complete and staged")
