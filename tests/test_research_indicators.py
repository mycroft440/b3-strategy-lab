...
class ResearchIndicatorTests(unittest.TestCase):
    def test_registered_volume_indicators_return_aligned_series(self) -> None:
    ...
    def test_mfi_uses_split_normalized_volume_consistently(self) -> None:
        ...
        self.assertEqual(build_indicator("money_flow_index", before), build_indicator("money_flow_index", after))

    def test_negative_volume_index_changes_only_when_volume_falls(self) -> None:
        candles = [
        ...
        self.assertEqual(values[1], 1000.0)
        self.assertEqual(round(values[2] or 0.0, 10), 1100.0)
